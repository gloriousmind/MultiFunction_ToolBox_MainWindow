...
static constexpr auto qt_meta_stringdata_ZN12MyMainWindowE = QtMocHelpers::stringData(
    "MyMainWindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12MyMainWindowE[] = {
...
Q_CONSTINIT const QMetaObject MyMainWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12MyMainWindowE.offsetsAndSizes,
    qt_meta_data_ZN12MyMainWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12MyMainWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *MyMainWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12MyMainWindowE.stringdata0))
